...
const numberArrayToString = (arr: number[]) => arr.map(a => a % 1 ? a.toString() : a.toFixed(1)).join(' ')
...
const xml = builder.create(createScriptObj('test description', createDefaultConfig()))
